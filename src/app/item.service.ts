...
export class ItemService {
  ...
  private selectedItem: any; // Holds the selected item
  ...
  private itemList = [
    ...
    { "id": 5, "name": "Gummybear", "description": "The bear that's sweeter than your ex ever was" },
    ...
    { "id": 14, "name": "Arrow", "description": "Cupid's got nothing on this pointy fellow" },
    { "id": 15, "name": "Fish", "description": "Goes swimmingly with chips, or just a good chat" },
    { "id": 16, "name": "Crystal", "description": "Shinier than a unicorn's dream journal" },
  ...
  // Predefined list of item rarities
  private rarityList = [
  ...
  // Get a random rarity based on drop chances
  ...
  // Update the inventory for a specific user
  ...
  // Add an item with a specific rarity to the user's inventory
